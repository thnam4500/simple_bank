...
const listTransfersFromAccountToAccount = `-- name: ListTransfersFromAccountToAccount :many
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers
...
type ListTransfersFromAccountToAccountParams struct {
	FromAccountID int64 `json:"from_account_id"`
	ToAccountID   int64 `json:"to_account_id"`
	Limit         int32 `json:"limit"`
	Offset        int32 `json:"offset"`
...
func (q *Queries) ListTransfersFromAccountToAccount(ctx context.Context, arg ListTransfersFromAccountToAccountParams) ([]Transfer, error) {
	rows, err := q.db.QueryContext(ctx, listTransfersFromAccountToAccount,
		arg.FromAccountID,
		arg.ToAccountID,
		arg.Limit,
		arg.Offset,
